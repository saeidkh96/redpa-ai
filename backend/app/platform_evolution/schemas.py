...
class ComplianceEvidenceRequest(BaseModel):
    ...
    evidence_type: str = Field(default="generic", max_length=120)
    source: str = Field(default="platform_evolution", max_length=250)
    subject: str = Field(default="platform", max_length=250)
