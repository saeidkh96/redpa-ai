...
Current stable milestone: **v9.0.0**
...
Release identity for v9.0.0 is aligned across the FastAPI application, Docker Compose runtime, Next.js frontend, Python SDK, and Helm `appVersion`.
