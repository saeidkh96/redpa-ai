# RedPA AI V7.0 — C4 Model

This document describes the architecture represented by the V7.0 repository. It distinguishes implemented local runtime components from deployment/reference assets.
