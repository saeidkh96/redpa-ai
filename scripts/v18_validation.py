...
from app.trusted_agents_v18.validation import validate
INPUT=Path("artifacts/v18-validation-input.json"); OUTPUT=Path("artifacts/v18-validation.json")
def main():
 ...
 print("RedPA AI V18 Trusted Agent Registry Validation"); print("="*48)
 ...
 OUTPUT.write_text(json.dumps({"version":"18.0.0","validation":"PASS" if passed else "FAIL","checks":[{"name":c.name,"passed":c.passed} for c in checks]},indent=2),encoding="utf-8")
